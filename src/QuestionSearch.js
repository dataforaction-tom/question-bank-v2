...
import {TextField, Select, MenuItem, Button, Grid, Card, CardContent, Typography, Pagination, Container} from '@mui/material';
...
function QuestionSearch() {
  ...
  return (
    <>
      <Container maxWidth="sm" style={{ marginTop: '20px',  backgroundColor: theme.palette.mode === 'light' ? '#f4f4f4' : theme.palette.background.default,  }}>
        <TextField
          value={searchTerm}
          ...
          <Grid item xs={12} sm={6} md={4} key={item.id}>
            <Card variant="outlined">
              <CardContent>
                ...
                <IconButton onClick={() => handleUpvote(item.id)} color="primary">
                  <StarIcon />
                </IconButton>
